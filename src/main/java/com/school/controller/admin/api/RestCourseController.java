...
public class RestCourseController {
	...
	public List<CourseModel> getAllClassrooms(HttpServletRequest request) {
		return courseService.findAll();
	}
	
	@RequestMapping(value={"/api-admin-course"}, method=RequestMethod.POST)
	public Long getCreateClassroom(HttpServletRequest request, @RequestBody CourseModel classroom) {
		return courseService.save(classroom, SystemConstant.INSERT);
	}
	
	@RequestMapping(value={"/api-admin-course"}, method=RequestMethod.PUT)
	public Long getUpdateClassroom(HttpServletRequest request, @RequestBody CourseModel classroom) {
	...
	public Long getDeleteClassroom(HttpServletRequest request, @RequestBody CourseModel classroom) {
