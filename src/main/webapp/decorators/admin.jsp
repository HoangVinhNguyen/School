...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/template/admin/css/custom.css'/>" />
...
<body class="no-skin">
	...
	<script src="<c:url value='/template/admin/assets/js/dataTables.tableTools.min.js'/>" ></script>
	...
	<script type="text/javascript" src="<c:url value='/template/admin/js/custom.js'/>"></script>
